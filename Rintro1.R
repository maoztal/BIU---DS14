...
l4[2]
l4[[2]] # same as to call the list with the name
l4$chrlst
...
### list of lists
l5 <- list(a=list(model="2018 Toyota Camry Hybrid", price=c(32400,50000), 52),
...
l6$list_list$a$price
l6$list_list[[3]]$model
...
ages.vec <- sample(25:35, size=7, replace=TRUE)
...
guys$city <- factor(guys$city)

class(guys$is.married)
